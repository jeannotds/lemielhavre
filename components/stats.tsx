        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {stats.map((stat, index) => {
            ...
            return (
              <div 
                key={index} 
                className="group relative bg-white rounded-2xl p-6 md:p-8 text-center border border-slate-100 hover:border-transparent hover:shadow-2xl transition-all duration-300 hover:-translate-y-2"
              >
                ...
                <div className="text-slate-800 font-semibold text-base md:text-lg mb-1">
                  {stat.label}
                </div>
