        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold">Le Miel Havre</span>
            </div>
              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  <a
                    ...
                    className={`w-11 h-11 bg-slate-800 rounded-lg flex items-center justify-center ${social.color} transition-all hover:scale-110 hover:shadow-lg`}
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <a href="tel:+44000888999" className="text-white hover:text-orange-400 transition-colors font-medium">
                +44-000-888-999
              </a>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="h-1 w-12 bg-gradient-to-r from-orange-500 to-red-500 rounded-full" />
            <div className="space-y-2">
              <a href="mailto:info@lemielhavre.com" className="block text-slate-400 hover:text-orange-400 transition-colors">
                info@lemielhavre.com
              </a>
              <a href="mailto:no.reply@lemielhavre.com" className="block text-slate-400 hover:text-orange-400 transition-colors">
