        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8 items-center justify-items-center">
          {partners.map((partner, index) => {
            ...
            return (
              <div
                key={index}
                className="group w-full max-w-[140px] aspect-square bg-white rounded-2xl shadow-md hover:shadow-2xl flex items-center justify-center transition-all duration-300 hover:-translate-y-2 border border-slate-100 hover:border-transparent"
              >
