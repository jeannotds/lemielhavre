        ...
        <div className="container mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div
                key={index}
                className="group relative overflow-hidden rounded-[20%] bg-white dark:bg-card shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-slate-100 dark:border-secondary"
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-black/20 to-transparent opacity-60 group-hover:opacity-100 transition-opacity duration-300" />
